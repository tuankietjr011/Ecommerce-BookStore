...
function BookCard({ isbn, title, author_id, img, price, onsale, liked }) {
    ...
    // SỬA LỖI: Thêm || [] để authors luôn là mảng
    ...
    // SỬA LỖI: Thêm ?. và || [] để tránh crash nếu authors chưa tải xong
    ...
    // SỬA LỖI: Đảm bảo filteredListReview luôn là mảng để dòng .map bên dưới chạy được
    ...
    // SỬA LỖI: Kiểm tra độ dài mảng trước khi chia để tránh ra NaN
        ...
        <div className="box-card" style={{ color: 'var(--black)' }} >
            ...
            <div className='box-content'>
                <div className="author-starts">
                    ...
                    {avgRating > 0 ? <span><StarFilled style={{ color: 'gold' }} /> {avgRating.toFixed(1)}</span> : <></>}
                </div>
                <h2>{title}</h2>
